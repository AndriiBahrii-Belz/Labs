...
namespace UnitTest1
{
	...
	public:
        ...
        TEST_METHOD(SumPositiveElementsBeforeMaxTest)
        {
            ...
            Assert::AreEqual(20.0, result, L"Sum of positive elements before max is incorrect");
        }
        ...
        TEST_METHOD(ReverseEvenElementsTest)
        {
            ...
            reverseEvenElementsRecursive(arr, 0, size - 1);

            double expected[size] = { 6.0, -1.0, 4.0, 3.0, 2.0, 5.0 };
